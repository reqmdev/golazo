...
exports.renderStandingsCard = renderStandingsCard;
...
const LeagueTable_1 = require("../components/LeagueTable");
...
const standingsGrid_1 = require("../tokens/standingsGrid");
const contentBlock_1 = require("../utils/contentBlock");
async function renderStandingsCard(view, theme, fetchLogo) {
    const labels = view.labels;
    const columns = (0, standingsGrid_1.buildStandingsColumns)(labels);
    const pageInfo = (0, paginate_1.paginateTable)(view.rows, {
        page: view.page,
        pageSize: cardLayout_1.card.maxStandingsRows,
    });
    ...
    const height = (0, cardLayout_1.standingsCardHeight)(rowCount, pageInfo.hasPagination);
    ...
    const innerChildren = [
        (0, SportsCardHeader_1.SportsCardHeader)({
            ...
            status: badge,
            icon: 'standings',
            iconSize: standingsGrid_1.STANDINGS_HEADER_ICON_SIZE,
            showDivider: false,
            theme,
        }),
    ];
    if (pageInfo.rows.length === 0) {
        ...
        innerChildren.push((0, LeagueTable_1.LeagueTable)({
            x: blockX,
            y: tableY,
            width: blockW,
            columns,
            rows: pageInfo.rows,
            logos,
            metrics: standingsGrid_1.STANDINGS_TABLE_METRICS,
            theme,
        }));
    }
...
//# sourceMappingURL=StandingsCard.js.map