...
exports.textStyles = exports.typeScale = void 0;
exports.buildTypographyCss = buildTypographyCss;
exports.typeScale = {
...
function buildTypographyCss() {
    const rules = [];
    for (const [name, spec] of Object.entries(exports.typeScale)) {
        rules.push(`.${name}{font-family:'${spec.family}',sans-serif;font-size:${spec.size}px;font-weight:${spec.weight};line-height:${spec.lineHeight}}`);
    }
