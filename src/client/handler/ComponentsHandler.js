...
class ComponentsHandler {
    ...
    load = () => {
        ...
        // Note: "selects" collection now supports all Discord select menu variants
        // (String, User, Role, Channel, Mentionable) via isAnySelectMenu() + customId.
        ...
        success(`Successfully loaded ${totalComponents} components.`);
    }
    ...
    reload = () => {
        ...
        clearModuleCache('/src/components/');
